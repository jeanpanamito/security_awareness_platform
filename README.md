...
```plantuml
@startuml
actor "Administrador (Atacante)" as Admin
participant "Panel de Admin" as Panel
participant "Base de Datos" as DB
participant "Servicio SMTP" as SMTP
...
```plantuml
@startuml
actor "Víctima (Usuario)" as User
participant "Cliente de Correo" as Email
participant "Servidor Web (Django)" as Web
database "Log de Rastreo" as Log
...
note right: ¡La contraseña es DESCARTADA aquí!
